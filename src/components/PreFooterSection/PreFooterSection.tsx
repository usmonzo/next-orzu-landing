				...
				<div className={styles.boxes_horizontal}>
					<div className={styles.blue_box}>
						<h1 className={styles.black_box_headline}>
							Простой процесс получения
							кредита
						</h1>
						<WhiteButton text={'Подробнее'}/>
					</div>
					<div className={styles.black_box}>
						<Image src={bank} alt={''} width={573.11} height={538} style={{opacity:'0.2'}} className={styles.bank_icon}/>
						<div style={{display:'flex',flexDirection:"column", gap:"30px"}}>
						<h1 className={styles.black_box_headline}>Приобретайте товары в рассрочку без переплаты</h1>
