'use client';
import { Input, Slider, SliderFilledTrack, SliderMark, SliderThumb, SliderTrack, Text, VStack } from '@chakra-ui/react';
			...
			<div className={styles.choice_container}>
				<>
					<div className={styles.input_container}>
						...
						<div className={styles.money_limits_container} style={{ color: 'black' }}>
							<p>50 см.</p>
							<p>25000 см.</p>
							<p>50000 см.</p>
						</div>
