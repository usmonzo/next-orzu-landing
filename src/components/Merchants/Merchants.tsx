...
const Merchants = () => {
	...
	const backgroundColor = useTransform(scrollY, [1600, 2000], ['#ffffff', '#16191d']);
	...
	return (
		<motion.section style={{ backgroundColor }}>
			<div className="merch-container">
				<div>
					<motion.h1 className="merch-headline" style={{ opacity: headlineOpacity, scale: headlineScale }}>
						Где же оплатить?
					</motion.h1>
				</div>
				<h1 className="merch-paragraph">Категории партнеров</h1>
				<motion.div className="merch-list" variants={container} initial="hidden" animate={onView ? 'visible' : ''}>
