			...
			<div className={styles.form_container}>
				<div className={styles.form_content}>
					...
					<div className={styles.form_inputs_container}>
						...
						<div className={styles.inputs_horizontal_container}>
							<InputGroup {...inputProps}>
								<InputLeftAddon color={'black'} children={'+992'} backgroundColor={'#d7dae0'} paddingRight={3} />
								<Input
									p={'20px 0'}
									_focus={{ borderColor: 'black', outline: 'none' }}
									size={'lg'}
					...
					<div className={styles.rules_container}>
						...
						>
							<p>
								Принимаю условия и даю согласие на обработку и использование моих персональных данных и разрешаю сделать
								запрос в бюро кредитных историй
							</p>
						</Checkbox>
					</div>
					<PrimaryButton
						onClick={() => postFormData('user')}
						isDisabled={
							formData.full_name === '' ||
