...
import { customSelectStyles, secondSelectStyle } from '@/components/CreditForm/SelectProps';
				...
				<div className={styles.form_container}>
					<div className={styles.form_content}>
						...
						<div className={styles.form_inputs_container}>
							<Input className={styles.form_input} {...inputProps} placeholder="Фамилия, имя и отчество" />
							<div className={styles.inputs_horizontal_container}>
								<Input className={styles.form_input} {...inputProps} placeholder="Номер телефона" />
								<Select
									isSearchable={false}
						...
						<div className={styles.rules_container}>
							...
							>
								<p>
									Принимаю условия и даю согласие на обработку и использование моих персональных данных и разрешаю
									сделать запрос в бюро кредитных историй
								</p>
							</Checkbox>
						</div>
						<PrimaryButton text={'Получить код'} aligned={'center'} zIndex={1} />
					</div>
